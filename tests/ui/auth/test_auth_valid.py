...
class TestAuthValid:
    ...
    @pytest.mark.asyncio
    async def test_auth_leads_to_account_page(self, page:Page, user_data, expected_text, main_menu):
    ...
    @pytest.mark.asyncio
    async def test_all_caps_in_email(self, page:Page, user_data, expected_text, main_menu):
        auth_page = AuthPage(page)
    ...
    @pytest.mark.asyncio
    async def test_various_register_in_email(self, page:Page, user_data, expected_text, main_menu):
        auth_page = AuthPage(page)
